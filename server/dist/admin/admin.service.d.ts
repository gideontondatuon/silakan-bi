...
export declare class AdminService {
    ...
    constructor(prisma: PrismaService, pemesananService: PemesananService, whatsapp: WhatsappService, notificationService: NotificationService);
    approvalIndex(query: any): Promise<{
        status: string;
        data: {
            items: {
                data: unknown[];
    ...
    approve(id: number, adminUser: any, catatanAdmin?: string): Promise<{
        status: string;
        message: string;
        data: any;
    }>;
    reject(id: number, adminUser: any, alasan: string): Promise<{
        status: string;
        message: string;
        data: any;
    }>;
    ...
    adminStorePemesanan(body: any, adminUser: any, filePath?: string): Promise<{
        status: string;
        message: string;
        data: any;
    }>;
    userIndex(query: any): Promise<{
        status: string;
        data: {
            admins: {
                department: {
