    ...
    <form method="post" action="<?php echo e(route('profile.update')); ?>" style="display:flex;flex-direction:column;gap:18px;">
        ...
        <div class="form-group" style="margin-bottom:0;">
            ...
            <div style="position:relative;">
                <input type="text" name="name" value="<?php echo e(old('name', $user->name)); ?>" required style="width:100%;padding:10px 14px 10px 42px !important;border:1px solid #cbd5e1;border-radius:10px;font-size:13.5px;outline:none;transition:all .2s;font-weight:600;" placeholder="Masukkan Nama Administrator">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group" style="margin-bottom:0;">
            ...
            <div style="position:relative;">
                <input type="text" name="username" value="<?php echo e(old('username', $user->username)); ?>" required style="width:100%;padding:10px 14px 10px 42px !important;border:1px solid #cbd5e1;border-radius:10px;font-size:13.5px;outline:none;transition:all .2s;font-weight:600;" placeholder="Masukkan Username Admin">
...
<?php else: ?>
    ...
    <div style="display:flex;flex-direction:column;gap:18px;">
        ...
        <div class="form-group" style="margin-bottom:0;">
            ...
            <div style="position:relative;">
                <input type="text" value="<?php echo e($user->name); ?>" readonly disabled style="width:100%;padding:10px 14px 10px 42px !important;border:1px solid #cbd5e1;border-radius:10px;background:#f8fafc;color:#1e293b;font-weight:700;font-size:13.5px;cursor:not-allowed;">
        ...
        <div class="form-group" style="margin-bottom:0;">
            ...
            <div style="position:relative;">
                <input type="text" value="<?php echo e($user->username); ?>" readonly disabled style="width:100%;padding:10px 14px 10px 42px !important;border:1px solid #cbd5e1;border-radius:10px;background:#f8fafc;color:#1e293b;font-weight:700;font-size:13.5px;font-family:monospace;cursor:not-allowed;">
                <i class="bi bi-person-badge" style="position:absolute;left:14px;top:50%;transform:translateY(-50%);color:#005baa;font-size:15px;"></i>
            </div>
        </div>
        ...
        <div class="form-group" style="margin-bottom:0;">
            ...
            <div style="position:relative;">
                <input type="text" value="<?php echo e($user->kode_unit); ?>" readonly disabled style="width:100%;padding:10px 14px 10px 42px !important;border:1px solid #cbd5e1;border-radius:10px;background:#f8fafc;color:#1e293b;font-weight:700;font-size:13.5px;cursor:not-allowed;">
