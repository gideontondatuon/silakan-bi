...
<div class="print-wrapper">
    ...
    <div class="action-bar no-print">
        <div class="action-bar-info">
            ...
            <span>Pratinjau Laporan Siap Cetak &bull; <strong><?php echo e($pemesanan->count()); ?> Record</strong> ditemukan</span>
        </div>
    ...
    <div class="kop-header">
        <img src="<?php echo e(asset('images/logo-bi4.png')); ?>" alt="Logo Bank Indonesia" class="kop-logo">
        <div class="kop-text">
    ...
    <div class="meta-strip">
        <div class="meta-item">
            ...
            <span>Periode:&nbsp;
                <strong>
                    <?php echo e(request('tanggal_mulai') ? \Carbon\Carbon::parse(request('tanggal_mulai'))->translatedFormat('d F Y') : 'Semua Tanggal'); ?>

                    <?php if(request('tanggal_selesai')): ?> &ndash; <?php echo e(\Carbon\Carbon::parse(request('tanggal_selesai'))->translatedFormat('d F Y')); ?> <?php endif; ?>
                </strong>
            </span>
        </div>
        <div class="meta-item">
            <i class="bi bi-building"></i>
            <span>Ruangan: <strong><?php echo e(request('ruangan_id') ? $pemesanan->first()?->ruangan?->nama_ruangan ?? 'Spesifik' : 'Semua Ruangan'); ?></strong></span>
        </div>
        <div class="meta-item">
            <i class="bi bi-filter-circle"></i>
            <span>Status: <strong><?php echo e(request('status') ?? 'Semua Status'); ?></strong></span>
        </div>
        <div class="meta-item">
            <i class="bi bi-clock-history"></i>
            <span>Dicetak: <strong><?php echo e(now()->translatedFormat('d F Y, H:i')); ?> WITA</strong></span>
        </div>
        <div class="meta-item">
            <i class="bi bi-person-badge"></i>
            <span>Oleh: <strong><?php echo e(auth()->user()->name ?? 'Administrator'); ?></strong></span>
        </div>
    </div>
    ...
    <div class="summary-grid">
        ...
        <div class="summary-card">
            ...
            <div>
                ...
                <strong style="color:#16a34a;"><?php echo e($disetujui); ?></strong>
            </div>
        </div>
        <div class="summary-card">
            ...
            <div>
                ...
                <strong style="color:#dc2626;"><?php echo e($ditolak); ?></strong>
            </div>
        </div>
        <div class="summary-card">
            ...
            <div>
                ...
                <strong style="color:#7c3aed;"><?php echo e($approvalRate); ?>%</strong>
                <div style="margin-top:4px;height:4px;background:#ede9fe;border-radius:9px;overflow:hidden;">
                    <div style="height:100%;width:<?php echo e($approvalRate); ?>%;background:#7c3aed;border-radius:9px;"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            ?>
            <tr>
                <td style="text-align:center;color:#94a3b8;font-weight:600;"><?php echo e($index + 1); ?></td>
                <td>
                    <span class="kode-badge"><?php echo e($item->kode_pemesanan); ?></span>
                </td>
                ...
                <td style="white-space:nowrap;font-weight:600;color:#475569;">
                    <?php echo e($item->waktu_mulai); ?> &ndash; <?php echo e($item->waktu_selesai); ?>
                ...
                <td style="font-weight:700;color:#1e293b;">
                    ...
                    <?php if($item->layout): ?>
                        <div style="font-size:7.5pt;color:#64748b;font-weight:400;margin-top:1px;"><?php echo e($item->layout->nama_layout); ?></div>
                    <?php endif; ?>
                </td>
                ...
                <td style="font-weight:700;color:#005baa;">
                    <?php echo e($item->user?->nama_unit ?? $item->user?->name ?? '—'); ?>
                ...
                <td>
                    <?php if($item->jenis_pic): ?>
                        <span class="jenis-badge <?php echo e($item->jenis_pic === 'Organik' ? 'jenis-organik' : 'jenis-non-organik'); ?>">
                ...
                <td style="text-align:center;">
                    <span class="status-badge <?php echo e($statusClass); ?>">
                        <?php echo e($statusIcon); ?> <?php echo e($statusVal); ?>
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;font-size:9pt;color:#475569;margin-bottom:24px;">
        <div style="display:flex;gap:16px;">
            <span>Total: <strong style="color:#003b73;"><?php echo e($total); ?> pemesanan</strong></span>
            <span>Disetujui: <strong style="color:#16a34a;"><?php echo e($disetujui); ?></strong></span>
            <span>Ditolak: <strong style="color:#dc2626;"><?php echo e($ditolak); ?></strong></span>
            <span>Pending: <strong style="color:#92400e;"><?php echo e($pending); ?></strong></span>
        </div>
    ...
    <div class="report-footer">
        ...
        <div class="signature-block">
            <p>Manado, <?php echo e(now()->translatedFormat('d F Y')); ?></p>
...
<?php /**PATH D:\Bank Indo\silakan\resources\views/admin/laporan/cetak.blade.php ENDPATH**/ ?>