...
<body>
    ...
    <div class="report-title">
        ...
        <p>Dicetak pada: <?php echo e(now()->translatedFormat('l, d F Y H:i')); ?> WITA</p>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><strong><?php echo e($item->kode_pemesanan); ?></strong></td>
                <td><?php echo e($item->tanggal_kegiatan ? $item->tanggal_kegiatan->format('d/m/Y') : '-'); ?></td>
                <td><?php echo e($item->waktu_mulai); ?> - <?php echo e($item->waktu_selesai); ?> WITA</td>
                <td><strong><?php echo e($item->ruangan->nama_ruangan ?? '-'); ?></strong></td>
                <td><?php echo e($item->judul_kegiatan); ?></td>
                <td><?php echo e($item->user?->nama_unit ?? $item->user?->name ?? 'User'); ?></td>
                <td><?php echo e($item->pic_kegiatan); ?></td>
                <td>
                    <?php
    ...
    <div class="footer">
        <div>
            Total Record: <strong><?php echo e($pemesanan->count()); ?> Data</strong>
        </div>
        <div class="signature">
