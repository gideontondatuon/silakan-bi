...
<body>
    ...
    <header class="display-header">
        <div class="header-brand">
            <img src="<?php echo e(asset('images/logo-bi4.png')); ?>" alt="Bank Indonesia Logo">
    ...
    <div class="display-container">
        ...
        <div class="display-card">
            ...
            <div id="live-container" style="flex:1;overflow-y:auto;">
                <?php $__empty_1 = true; $__currentLoopData = $kegiatanLive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $live): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="live-item">
                    <div class="live-item-header">
                        <span class="live-room"><i class="bi bi-building"></i> <?php echo e($live->ruangan->nama_ruangan); ?></span>
                        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
                            <span class="live-time-badge">
                                <i class="bi bi-clock"></i> <?php echo e($live->waktu_mulai); ?> - <?php echo e($live->waktu_selesai); ?>

                            </span>
                            <span class="live-countdown" data-end-time="<?php echo e($live->tanggal_kegiatan->format('Y-m-d')); ?>T<?php echo e($live->waktu_selesai); ?>">
                                <i class="bi bi-hourglass-split" style="animation:spinHourglass 2.5s infinite linear;"></i>
                                <span class="countdown-val">Sisa ...</span>
                            </span>
                        </div>
                    </div>
                    <div class="live-title"><?php echo e($live->judul_kegiatan); ?></div>
                    <div class="live-meta">
                        <span><i class="bi bi-people-fill" style="color:#60a5fa;"></i> <?php echo e($live->user->nama_unit ?? $live->user->name); ?></span>
                        <span><i class="bi bi-person-fill" style="color:#60a5fa;"></i> PIC: <?php echo e($live->pic_kegiatan); ?></span>
                    </div>
                </div>
            ...
            <div class="desktop-schedule-view" style="flex:1;overflow-y:auto;">
                <table class="today-table">
                    ...
                    <tbody id="today-tbody">
                        <?php $__empty_1 = true; $__currentLoopData = $kegiatanHariIni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $today): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td style="font-weight:700;color:#fef08a;white-space:nowrap;">
                                <i class="bi bi-clock"></i> <?php echo e($today->waktu_mulai); ?> - <?php echo e($today->waktu_selesai); ?>

                            </td>
                            <td style="font-weight:700;color:#93c5fd;">
                                <?php echo e($today->ruangan->nama_ruangan); ?>

                            </td>
                            <td>
                                <strong><?php echo e($today->judul_kegiatan); ?></strong>
                            </td>
                            <td style="color:#cbd5e1;">
                                <?php echo e($today->user->nama_unit ?? $today->user->name); ?>
            ...
            <div class="mobile-schedule-view">
                ...
                <div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.12);border-radius:14px;padding:14px 16px;margin-bottom:12px;">
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;flex-wrap:wrap;gap:6px;">
                        <span style="font-weight:800;color:#fef08a;font-size:13px;"><i class="bi bi-clock"></i> <?php echo e($today->waktu_mulai); ?> - <?php echo e($today->waktu_selesai); ?> WITA</span>
                        <span style="font-weight:700;color:#93c5fd;font-size:12px;background:rgba(147,197,253,0.15);padding:3px 10px;border-radius:6px;border:1px solid rgba(147,197,253,0.25);">
                            <i class="bi bi-building"></i> <?php echo e($today->ruangan->nama_ruangan); ?>

                        </span>
                    </div>
                    <div style="font-weight:800;font-size:15px;color:#ffffff;margin-bottom:6px;line-height:1.35;"><?php echo e($today->judul_kegiatan); ?></div>
                    <div style="font-size:12.5px;color:#cbd5e1;display:flex;align-items:center;gap:6px;">
                        <i class="bi bi-people-fill" style="color:#60a5fa;"></i> <?php echo e($today->user->nama_unit ?? $today->user->name); ?>
    ...
    <footer class="display-footer">
        ...
        <div id="last-update">
            Terakhir Diperbarui: <?php echo e(now()->translatedFormat('H:i:s')); ?> WITA
        </div>
    </footer>
...
<?php /**PATH D:\Bank Indo\silakan\resources\views/display/index.blade.php ENDPATH**/ ?>