...
<div class="detail-container">
    ...
    <div class="detail-card">
        ...
        <div class="detail-grid">
            ...
            <div>
                <label>Status</label>
                <p><span class="badge badge-warning"><i class="bi bi-clock-history"></i> <?php echo e($pemesanan->status->label()); ?></span></p>
            </div>
        </div>
    </div>
    ...
    <div class="detail-card">
        ...
        <div class="detail-grid">
            ...
            <div>
                ...
                <p><?php echo e($pemesanan->pic_kegiatan); ?> <?php echo e($pemesanan->no_wa_pic ? '('.$pemesanan->no_wa_pic.')' : ''); ?></p>
            </div>
            <div>
