...
<head>
    ...
    <title>404 — Halaman Tidak Ditemukan | SILAKAN Bank Indonesia</title>
...
<body>
    <div class="error-card">
        <div class="error-badge">
            <i class="bi bi-compass"></i> HALAMAN TIDAK DITEMUKAN
        </div>
        <div class="error-code">404</div>
        <h1 class="error-title">Halaman Tidak Ditemukan</h1>
        <p class="error-desc">
            Tautan yang Anda tuju tidak ditemukan, telah dipindahkan, atau pemesanan terkait telah dihapus dari sistem SILAKAN.
        </p>
        <a href="<?php echo e(auth()->check() ? route('dashboard') : route('login')); ?>" class="btn-home">
...
<?php /**PATH D:\Bank Indo\silakan\resources\views/errors/404.blade.php ENDPATH**/ ?>