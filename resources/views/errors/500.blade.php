...
<head>
    ...
    <title>500 — Gangguan Sistem | SILAKAN Bank Indonesia</title>
...
<body>
    <div class="error-card">
        <div class="error-badge">
            <i class="bi bi-exclamation-triangle-fill"></i> KENDALA SERVER
        </div>
        <div class="error-code">500</div>
        <h1 class="error-title">Terjadi Kendala Sistem</h1>
        <p class="error-desc">
            Sistem SILAKAN mendeteksi gangguan saat memproses permintaan Anda. Log error telah dicatat secara otomatis untuk ditindaklanjuti oleh Tim IT KPwBI Prov. Sulut.
        </p>
