...
<head>
    ...
    <title>419 — Sesi Kedaluwarsa | SILAKAN Bank Indonesia</title>
...
<body>
    <div class="error-card">
        <div class="error-badge">
            <i class="bi bi-clock-history"></i> SESI BERAKHIR
        </div>
        <div class="error-code">419</div>
        <h1 class="error-title">Sesi Anda Telah Berakhir</h1>
        <p class="error-desc">
            Demi keamanan sistem perbankan dan data Anda, sesi aktif atau token keamanan halaman telah kedaluwarsa karena tidak ada aktivitas dalam beberapa waktu. Silakan muat ulang atau masuk kembali.
        </p>
        <a href="{{ route('login') }}" class="btn-home">
            <i class="bi bi-box-arrow-in-right"></i> Masuk Kembali ke Akun
        </a>
