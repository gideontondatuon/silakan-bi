...
- [BAGIAN AWAL: PENDAHULUAN](#bagian-awal-pendahuluan)
...
- [BAB 3: INFORMASI TAMBAHAN (TIPS & CATATAN PENTING)](#bab-3-informasi-tambahan-tips--catatan-penting)
  - 3.1 Ketentuan Pengunggahan Berkas Disposisi
...
3. Klik pada balok agenda kegiatan untuk melihat rincian nama unit peminjam, jam rapat, dan nama PIC.
...
- **Nama & Jenis PIC** *(Wajib)*: Nama penanggung jawab kegiatan dan kategori (Organik / Non Organik).
...
3. Rincian tanggal, jam, ruangan, PIC, dan status tampil lengkap. Klik tautan **Unduh Berkas** untuk mengunduh kembali dokumen disposisi.
...
## 💡 **BAB 3: INFORMASI TAMBAHAN (TIPS & CATATAN PENTING)**

### **3.1 Ketentuan Berkas Lembar Disposisi**
- Format berkas yang didukung adalah **PDF, JPG, JPEG, atau PNG**.
- Ukuran berkas maksimum adalah **5 MB**. Dokumen yang melebihi batas ini akan otomatis ditolak oleh sistem dengan popup peringatan.
- Pastikan berkas disposisi telah memuat persetujuan atau tanda tangan pimpinan unit yang berwenang.

### **3.2 Standar Zona Waktu Operasional**
- Jam operasional dan validasi pemesanan ruangan mengacu secara ketat pada **Waktu Indonesia Tengah (WITA / GMT+8)**.
- Pemesanan tidak dapat dilakukan pada jam yang telah terlewat untuk hari yang sama.

### **3.3 Saluran Konfirmasi WhatsApp Gateway**
- Pastikan nomor WhatsApp PIC ditulis dengan benar (contoh: `08123456789`) dan dalam kondisi aktif.
